<nav x-data="{ open: false }" class="bg-white/80 backdrop-blur-md border-b border-amber-900/20 shadow-lg sticky top-0 z-50">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-9 w-auto fill-current text-amber-800" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border-2 border-amber-900/20 text-sm leading-4 font-bold rounded-lg text-amber-900 bg-white/80 hover:bg-amber-50 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-amber-900/20">
            <div class="px-4">
